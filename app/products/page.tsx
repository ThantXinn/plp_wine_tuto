...
const ProductPage = () => {
  ...
  {
    /*
  const ProductsQueryReturn = () => {
    let getAllProducts = groq`*[_type == 'product' && originalPrice >= ${priceValue[0]} && originalPrice <= ${priceValue[1]}]{
    ...,
  ...
  return (
    <Container className='flex flex-col justify-center'>
      <header className='font-bold leading-8 text-lg p-4'>
        Showing {products.length} Fortified Wines and Red wines between ¥1,000 -
